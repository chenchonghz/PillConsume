...
-(void)updateLabels{
    ...
    [redLabel setText:[NSString stringWithFormat:@"红 %.f",redSlider.value*255]];
    [greenLabel setText:[NSString stringWithFormat:@"绿 %.f",greenSlider.value*255]];
    [blueLabel setText:[NSString stringWithFormat:@"蓝 %.f",blueSlider.value*255]];
